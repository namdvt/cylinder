...
from mmdet.models.backbones.modules import AdaptiveRotatedConv2d, RountingFunction

INF = 1e8
import torch.nn as nn

class ConvModule(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, num_groups, eps=1e-05, affine=True, inplace=True):
        ...
        self.gn = nn.GroupNorm(num_groups=num_groups, num_channels=out_channels, eps=eps, affine=affine)
...
class RotatedFCOSHeadArc(RotatedAnchorFreeHead):
        ...
        for i in range(self.stacked_convs):
            ...
            self.cls_convs.append(
                ConvModule(
                    ...
                    stride=1,
                    padding=1,
                    num_groups=self.norm_cfg['num_groups']))
    ...
    def _init_predictor(self):
        ...
        self.conv_cls = AdaptiveRotatedConv2d(
        ...
        self.conv_reg = AdaptiveRotatedConv2d(
                in_channels=self.feat_channels,
                out_channels=4,
                kernel_size=3, 
                padding=1,
