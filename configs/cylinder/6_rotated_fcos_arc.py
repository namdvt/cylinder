dataset_type = 'EllipseDataset'
data_root = '/home/dcq3736/Datasets/EllipseDetection/GED/'
angle_version='le135'
...
work_dir = 'work_dirs/rotated_fcos_arc'
auto_resume = False
gpu_ids = range(0, 1)
